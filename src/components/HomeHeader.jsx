    ...
    return(
        <header className="landing-hed">
            ...
            <div className="header-status-div">
                {!isLoggedIn && <button className="btn header-btn signin-btn">
                <Link to="/signup">Sign Up</Link>
                </button>}
               { isLoggedIn? <button className="btn header-btn login-btn" onClick={logout}>Log Out</button>:
                <button className="btn header-btn login-btn">
                <Link to="/login">Log In</Link>
                </button>}
                {isLoggedIn && userName && <div className="prof-pic-name">
                {proPic?<img
                className="owner-profile"
                src={proPic}
                alt=""
