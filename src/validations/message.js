...
const messageSchema = Yup.object().shape({
    ...
    phone: Yup.string("Only string allowed!").required("Phone Number is required!").matches(/^\+\d{1,3}\d{8,14}$/, "Invalid Phone Number!"),
    message: Yup.string("Only string allowed!").required("Message is required!").min(20, "Message is too short!"),
})
