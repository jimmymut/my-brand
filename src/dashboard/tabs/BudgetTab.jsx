  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(210px,1fr))', gap: 18, marginBottom: 22 }}>
        <div style={card}>
          <div style={{ fontSize: 13, color: 'var(--muted)', fontWeight: 600, marginBottom: 8 }}>Planned total · {monthLabel(CURRENT)}</div>
        ...
        <div style={{ padding: '20px 22px', borderRadius: 16, background: d.budgetOver ? 'linear-gradient(160deg,rgba(251,113,133,0.12),rgba(251,113,133,0.02))' : 'linear-gradient(160deg,rgba(52,211,153,0.12),rgba(52,211,153,0.02))', border: `1px solid ${d.budgetOver ? 'rgba(251,113,133,0.25)' : 'rgba(52,211,153,0.25)'}` }}>
          ...
          <div style={{ fontSize: 12, color: 'var(--muted2)', marginTop: 6 }}>resets at the start of next month</div>
        </div>
      </div>
      ...
      <div style={{ padding: 24, borderRadius: 18, background: 'var(--surface)', border: '1px solid var(--border)', marginBottom: 18 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
          <div>
            <h3 style={{ fontFamily: "'Space Grotesk'", fontWeight: 600, fontSize: 17, color: 'var(--strong)' }}>Budget plan · {monthLabel(CURRENT)}</h3>
            <div style={{ fontSize: 12.5, color: 'var(--muted3)', marginTop: 3 }}>What you plan to spend &amp; set aside this month</div>
          </div>
      ...
      <div style={{ padding: 24, borderRadius: 18, background: 'var(--surface)', border: '1px solid var(--border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
          <h3 style={{ fontFamily: "'Space Grotesk'", fontWeight: 600, fontSize: 17, color: 'var(--strong)' }}>Recorded spending this month · for reference</h3>
        </div>
